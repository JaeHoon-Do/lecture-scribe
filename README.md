...
| **Tablet HTML** | Same content as a single self-contained file with embedded images — opens directly in the iPad Files app. Landscape layout: slides on the left, notes on the right. |
...
normalised, and scored against every rendered PDF page — then a **monotone dynamic-programming
